...
#Handel Files
#File Studets
def handelFilePickle():
     listStudentTemporary = []
     for student in listStudent:
         listStudentTemporary.append(student.id)
         listStudentTemporary.append(student.name)
         listStudentTemporary.append(student.dob)
     listCourseTemporary = []
     for course in listCourse:
         listCourseTemporary.append(course.id)
         listCourseTemporary.append(course.name)
     listMarkTemporary = []
     for mark in listMark:
         listCourseTemporary.append(mark.studentName)
         listCourseTemporary.append(mark.courseName)
         listCourseTemporary.append(mark.mark)
     pickle_out1 = open('students.pickle', 'wb')
     pickle.dump(listStudentTemporary, pickle_out1)
     pickle_out1.close()
     pickle_out2 = open('courses.pickle', 'wb')
     pickle.dump(listCourseTemporary, pickle_out2)
     pickle_out2.close()
     pickle_out3 = open('marks.pickle', 'wb')
     pickle.dump(listMarkTemporary, pickle_out3)
     pickle_out3.close()
#Main
index = 0
numberStudent()
